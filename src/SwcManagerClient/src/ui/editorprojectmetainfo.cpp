    ...
    for (int i = 0; i < responseAllUser.userinfo_size(); i++) {
        ...
        if(bFind) {
            ...
            ui->UserPermissionOverride->setItem(i, 1,
                                     new QTableWidgetItem(
                                         QString::fromStdString(
                                             std::to_string(permissionOverride.projectpermission().writepermissionadddata()))));
            ui->UserPermissionOverride->setItem(i, 2,
                                     new QTableWidgetItem(
                                         QString::fromStdString(
                                             std::to_string(permissionOverride.projectpermission().writepermissionmodifydata()))));
            ui->UserPermissionOverride->setItem(i, 3,
                                     new QTableWidgetItem(
                                         QString::fromStdString(
                                             std::to_string(permissionOverride.projectpermission().writepermissiondeletedata()))));
            ui->UserPermissionOverride->setItem(i, 4,
                                     new QTableWidgetItem(
                                         QString::fromStdString(
                                             std::to_string(permissionOverride.projectpermission().readperimissionquery()))));
